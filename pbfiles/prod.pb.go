...
type ProdRequest struct {
	...
	Area   Area  `protobuf:"varint,2,opt,name=area,proto3,enum=Area" json:"area,omitempty"`         // 商品区域
}
...
func (x *ProdRequest) GetArea() Area {
	if x != nil {
		return x.Area
	}
	return Area_A
...
var file_prod_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x0a, 0x61, 0x72, 0x65, 0x61, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x1a, 0x11, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x2f, 0x6d, 0x75, 0x73, 0x69, 0x63, 0x2e, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x22, 0x41, 0x0a, 0x0b, 0x50, 0x72, 0x6f, 0x64, 0x52, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x12, 0x17, 0x0a, 0x07, 0x70, 0x72, 0x6f, 0x64, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x05, 0x52, 0x06, 0x70, 0x72, 0x6f, 0x64, 0x49, 0x64, 0x12, 0x19, 0x0a, 0x04, 0x61,
	0x72, 0x65, 0x61, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x05, 0x2e, 0x41, 0x72, 0x65, 0x61,
	0x52, 0x04, 0x61, 0x72, 0x65, 0x61, 0x22, 0x2d, 0x0a, 0x0c, 0x50, 0x72, 0x6f, 0x64, 0x52, 0x65,
	...
	0x52, 0x04, 0x73, 0x69, 0x7a, 0x65, 0x22, 0x3e, 0x0a, 0x10, 0x50, 0x72, 0x6f, 0x64, 0x52, 0x65,
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x2a, 0x0a, 0x04, 0x6c, 0x69,
	...
	0x52, 0x04, 0x6c, 0x69, 0x73, 0x74, 0x32, 0x92, 0x02, 0x0a, 0x0b, 0x50, 0x72, 0x6f, 0x64, 0x53,
	...
	0x7d, 0x12, 0x56, 0x0a, 0x0d, 0x47, 0x65, 0x74, 0x50, 0x72, 0x6f, 0x64, 0x53, 0x74, 0x6f, 0x63,
	...
	0x69, 0x73, 0x74, 0x22, 0x14, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x0e, 0x12, 0x0c, 0x2f, 0x76, 0x31,
	0x2f, 0x70, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x73, 0x12, 0x50, 0x0a, 0x0b, 0x47, 0x65, 0x74,
	...
	0x0c, 0x2e, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x2e, 0x4d, 0x75, 0x73, 0x69, 0x63, 0x22, 0x1c, 0x82,
	0xd3, 0xe4, 0x93, 0x02, 0x16, 0x12, 0x14, 0x2f, 0x76, 0x31, 0x2f, 0x6d, 0x75, 0x73, 0x69, 0x63,
	0x73, 0x2f, 0x7b, 0x70, 0x72, 0x6f, 0x64, 0x5f, 0x69, 0x64, 0x7d, 0x42, 0x0e, 0x5a, 0x0c, 0x67,
	0x72, 0x70, 0x63, 0x2f, 0x70, 0x62, 0x66, 0x69, 0x6c, 0x65, 0x73, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
...
var file_prod_proto_goTypes = []interface{}{
	...
	(Area)(0),                // 4: Area
	(*Music)(nil),            // 5: model.Music
}
var file_prod_proto_depIdxs = []int32{
	4, // 0: services.ProdRequest.area:type_name -> Area
	1, // 1: services.ProdResponseList.list:type_name -> services.ProdResponse
	0, // 2: services.ProdService.GetProdStock:input_type -> services.ProdRequest
	2, // 3: services.ProdService.GetProdStocks:input_type -> services.QuerySize
	0, // 4: services.ProdService.GetProdInfo:input_type -> services.ProdRequest
	1, // 5: services.ProdService.GetProdStock:output_type -> services.ProdResponse
	3, // 6: services.ProdService.GetProdStocks:output_type -> services.ProdResponseList
	5, // 7: services.ProdService.GetProdInfo:output_type -> model.Music
...
type ProdServiceClient interface {
	...
	GetProdInfo(ctx context.Context, in *ProdRequest, opts ...grpc.CallOption) (*Music, error)
}
...
func (c *prodServiceClient) GetProdInfo(ctx context.Context, in *ProdRequest, opts ...grpc.CallOption) (*Music, error) {
	out := new(Music)
...
type ProdServiceServer interface {
	...
	// music包名不同，才用model.Music引入
	GetProdInfo(context.Context, *ProdRequest) (*Music, error)
}
...
func (*UnimplementedProdServiceServer) GetProdInfo(context.Context, *ProdRequest) (*Music, error) {
