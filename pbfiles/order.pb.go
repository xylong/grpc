...
var file_order_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x1a, 0x11, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x2f, 0x6f,
	0x72, 0x64, 0x65, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x41, 0x0a, 0x0d, 0x4f, 0x72,
	...
	0x08, 0x4e, 0x65, 0x77, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x12, 0x0c, 0x2e, 0x6d, 0x6f, 0x64, 0x65,
	0x6c, 0x2e, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x1a, 0x17, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63,
	0x65, 0x73, 0x2e, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	0x22, 0x00, 0x42, 0x0e, 0x5a, 0x0c, 0x67, 0x72, 0x70, 0x63, 0x2f, 0x70, 0x62, 0x66, 0x69, 0x6c,
...
var file_order_proto_goTypes = []interface{}{
	...
	(*model.Order)(nil),   // 1: model.Order
}
var file_order_proto_depIdxs = []int32{
	1, // 0: services.OrderService.NewOrder:input_type -> model.Order
...
type OrderServiceClient interface {
	NewOrder(ctx context.Context, in *model.Order, opts ...grpc.CallOption) (*OrderResponse, error)
}
...
func (c *orderServiceClient) NewOrder(ctx context.Context, in *model.Order, opts ...grpc.CallOption) (*OrderResponse, error) {
...
type OrderServiceServer interface {
	NewOrder(context.Context, *model.Order) (*OrderResponse, error)
}
...
func (*UnimplementedOrderServiceServer) NewOrder(context.Context, *model.Order) (*OrderResponse, error) {
...
func _OrderService_NewOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServiceServer).NewOrder(ctx, req.(*model.Order))
	}
